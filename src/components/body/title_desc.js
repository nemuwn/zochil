...
function Title_desc() {
  return (
    <div className="title_desc">
      ...
      <h1 class="title_text">
        Онлайн бизнесээ <br /> одоо эхлүүл
      </h1>
      <p class="long_desc white-text ">
        Та манай платформыг ашиглан 3 минутын дотор онлайн дэлгүүрээ нээж
        захиалга, агуулах, төлбөр, хүргэлтээ автоматжуулаарай.
      </p>
      <div class="btns">
